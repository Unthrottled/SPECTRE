...
public final class ServiceClassMethods {
    public static Method findProviderCreatorMethod(Class<? extends Service> serviceToProxy) {
        for (Method method : serviceToProxy.getDeclaredMethods()) {
