...
public final class ServiceState {
    private volatile ServiceStatus serviceStatus = ServiceStatus.ALIVE;

    public synchronized boolean isServiceAlive() {
        return ServiceStatus.ALIVE.equals(serviceStatus);
    }
    ...
    public synchronized void serviceReAnimated(){
        serviceStatus = ServiceStatus.ALIVE;
    }

    public enum ServiceStatus {ALIVE, DEAD}
}
